...
class CapacitacionForm extends React.Component {
  constructor(props) {
    super(props)
  }
  render() {
      ...
      <Layout className="inner-layout ">
        ...
        <Content>
          <Tabs defaultActiveKey="1" style={{ margin: '2em 0.7em 0 0.7em' }}>
            ...
            <TabPane key="1" tab="Inicio" className="panel">
              <h3>Capacitacion: Página de Inicio</h3>
              <hr></hr>
              <p></p>
              <Form>
                <h4>Título</h4>
                <Input
                  type="text"
                  name="titulo_de_la_capacitacion"
                  placeholder="Utiliza un nombre atractivo."
                  value={this.props.post && this.props.post.post_title}
                />
                <h4>Descripción</h4>
                <p>Describe el mismo, los objetivos y herramientas que el empresario podrá aplicar a su negocio.</p>
                <Input
                  type="text"
                  name="descripcion_de_la_capacitacion"
                  placeholder="Maximo: 144 caracteres."
                  value={this.props.post && this.props.post.post_content}
                  maxLength="144" />
                <h4>Categorías</h4>
                {/* <Input type="text" name="categoria_de_la_capacitacion" placeholder="Inserta la descripción de tu capacitacion." maxLength="144" /> */}
                <Select
          mode="multiple"
          size={'default'}
        ...
        >
          {children}
                ...
                <Input
                  type="text"
                  name="precio_de_la_capacitacion"
              ...
              <Alert
                message="Todos los instructores visibles de este capacitacion deben completar su perfil para que el capacitacion se pueda publicar. Esto incluye el nombre, una foto y una breve biografía (mínimo de 50 palabras)."
                type="warning" />
            ...
            <TabPane key="2" tab="Módulos y clases">
              <h4>Estrucutra de la capacitación</h4>

            </TabPane>
            <TabPane key="3" tab="Imagen">
              <h4>Imagen de la capacitacion</h4>
...
class CapacitacionEditor extends React.Component {
  constructor(props) {
    super(props)
  ...
  render() {
    ...
    return (
      <CapacitacionForm post={post} goHomeClick={this.goHomeClick}></CapacitacionForm>
    )
  }
}
...
function mapStateToProps(state) {
  const { capacitaciones, authentication } = state
  ...
  console.log(" mapStateToProps", capacitaciones)
  const {
    isFetching,
    lastUpdated,
    items: posts
...
export default connect(mapStateToProps)(CapacitacionEditor)